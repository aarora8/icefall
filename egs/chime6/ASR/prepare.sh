...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
  ...
  mkdir -p data/manifests data/manifests data/fbank
...
# local/queue.pl --mem 30G --gpu 4 --config local/coe.conf tdnn_lstm_ctc/exp/train.log ~/miniconda3/envs/k2/bin/python3 ./tdnn_lstm_ctc/train.py
# local/queue.pl --mem 30G --gpu 1 --config local/coe.conf data/decode.log ~/miniconda3/envs/k2/bin/python3 ./tdnn_lstm_ctc/decode.py
